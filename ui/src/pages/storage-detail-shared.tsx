...
export function DetailField(props: {
  ...
  return (
    <div className="min-w-0">
      ...
      <div
        className={mono ? 'mt-1 truncate font-mono text-sm' : 'mt-1 text-sm'}
      >
        {children || '-'}
      </div>
    </div>
...
export function EmptyTableRow({ colSpan }: { colSpan: number }) {
  ...
  return (
    <tr className="border-b transition-colors">
      <td
        colSpan={colSpan}
        className="h-16 p-2 text-center text-sm text-muted-foreground"
      >
    ...
    <div className="space-y-2">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex w-full flex-wrap gap-2 md:w-auto md:justify-end">
          ...
          />
          {renderHeaderActions
            ? renderHeaderActions(resource, handleManualRefresh)
            : null}
          <Button
            variant="destructive"
            size="sm"
