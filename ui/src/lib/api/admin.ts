...
export const getAppearancePreference = async (): Promise<
  Partial<AppearancePreferencePayload>
> => {
  return apiClient.get<Partial<AppearancePreferencePayload>>(
...
export const getViewerPreference = async (): Promise<
  Partial<ViewerPreferencePayload>
> => {
...
export const getWorkspacePreference = async (): Promise<
  Partial<WorkspacePreferencePayload>
> => {
  return apiClient.get<Partial<WorkspacePreferencePayload>>(
...
export const getResourceTablePreference = async (): Promise<
  Partial<ResourceTablePreferencePayload>
> => {
...
export const getUIPreference = async (): Promise<
  Partial<UIPreferencePayload>
> => {
