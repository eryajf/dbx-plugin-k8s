...
func (plugin *plugin) Handle(
	...
	case "connection/test":
		...
		return map[string]any{"success": true, "message": "DBX Plugin K8s is ready", "connection": connection}, nil
	...
	case "dbx-plugin-k8s/ping":
		return map[string]any{"ok": true, "plugin": "com.example.dbx-plugin-k8s", "language": "go", "connectionId": values["connectionId"]}, nil
	default:
